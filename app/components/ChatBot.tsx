...
export default function ChatBot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isChatOpen && (
        <div className="fixed bottom-20 right-6 z-50 bg-white border shadow-lg rounded-lg w-80 h-96 flex flex-col">
          <div className="p-4 border-b flex justify-between items-center bg-[#001282] text-white rounded-t-lg">
            <h4 className="text-lg font-semibold">SkillUp Chat</h4>
