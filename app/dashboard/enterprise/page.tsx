            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
              <div>
                ...
                <p className="text-gray-500">
                  Bienvenue sur votre espace entreprise, gérez vos formations et
                  formateurs.
                </p>
              </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      ...
                      { name: "Data Science & IA", progress: 45, employees: 8 },
                      {
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        image: "/placeholder.svg?height=40&width=40&text=TD",
                      },
                      {
                        name: "Camille Leroy",
                        ...
                        rating: 4.7,
                        availability: "Disponible",
                        image: "/placeholder.svg?height=40&width=40&text=CL",
                      },
                    ].map((trainer, i) => (
                      <div
                        key={i}
